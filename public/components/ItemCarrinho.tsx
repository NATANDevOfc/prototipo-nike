...
function ItemCarrinho() {
  // Dados de exemplo. No futuro, isso viria de fora do componente (via "props").
  const item = {
  ...
  return (
    <div className="w-full bg-zinc-800 p-3 rounded-lg flex items-center space-x-4 text-white mb-3 last:mb-0">
